...
const testimonials = [
  { id: 1, name: 'Carlos Silva', role: 'Diretor de TI - Varejo Mais', content: 'A TechVarejo aumentou em 40% nossas vendas online.', rating: 5 },
  { id: 2, name: 'Ana Paula Mendes', role: 'Gerente de E-commerce - Moda Total', content: 'Integração impecável do ERP com marketplace.', rating: 5 },
  { id: 3, name: 'Roberto Almeida', role: 'CEO - Supermercado Preço Bom', content: 'Gestão completa e eficiência operacional.', rating: 5 },
];
